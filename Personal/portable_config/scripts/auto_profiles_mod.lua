...
-- changes start here
mp.add_key_binding(nil, 'reload-profiles', load_profiles)
--usage in input.conf: KEY script-binding reload-profiles
--make sure you add load-auto-profiles=no to your mpv.conf
